...
// 2. During production: Use Babel to transpile our code into an older version of JavaScript and polyfil our code (converting back to ES5 to ensure the browser compatibility for all the users)